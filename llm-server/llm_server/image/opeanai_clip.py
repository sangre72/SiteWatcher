...
from sqlalchemy import create_engine, Column, String, ARRAY, JSON, insert, select, Float, cast, func
...
#CREATE TABLE image_vectors_1024 (
...
class ImageVector(Base):
    ...
    vector = Column(ARRAY(Float), nullable=False)  # ARRAY(Float) 사용
    meta_data = Column(JSON)  # 'metadata' 대신 'meta_data' 사용
